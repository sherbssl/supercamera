...
export const CAMERA_DIRECTORY: Record<string, CameraMetaEntry> = {
  ...
  '6701': {
    name: 'PIE (Towards Changi Airport) - Jalan Anak Bukit',
    road: 'PIE',
    area: 'Bukit Timah',
  ...
  '6703': {
    name: 'PIE (Towards Tuas) - Adam Road',
    road: 'PIE',
    area: 'Bukit Timah',
  ...
  '6704': {
    name: 'PIE (Towards Tuas) - Mount Pleasant',
    road: 'PIE',
    area: 'Toa Payoh',
    direction: 'Towards Tuas',
    isCheckpoint: false,
  ...
  '6705': {
    name: 'PIE (Towards Changi Airport) - Kallang Way',
    road: 'PIE',
    area: 'Kallang',
    direction: 'Towards Changi Airport',
    isCheckpoint: false,
  ...
  '6708': {
    name: 'PIE (Towards Tuas) - Kim Keat',
    road: 'PIE',
    area: 'Toa Payoh',
    direction: 'Towards Tuas',
    isCheckpoint: false,
  ...
  '6711': {
    name: 'PIE (Towards Changi Airport) - Eunos Flyover',
    road: 'PIE',
    area: 'Eunos',
    direction: 'Towards Changi Airport',
    isCheckpoint: false,
  ...
  '6712': {
    name: 'PIE (Towards Tuas) - Bedok North',
    road: 'PIE',
    area: 'Bedok',
    direction: 'Towards Tuas',
    isCheckpoint: false,
  ...
  '2703': {
    name: 'BKE (Towards Woodlands) - Chantek Flyover',
    road: 'BKE',
    area: 'Bukit Timah',
  ...
  '2705': {
    name: 'BKE (Towards Woodlands) - Dairy Farm',
    road: 'BKE',
    area: 'Bukit Panjang',
    direction: 'Towards Woodlands',
    isCheckpoint: false,
  ...
  '2707': {
    name: 'BKE (Towards PIE) - Mandai Road',
    road: 'BKE',
    area: 'Mandai',
  ...
  '1701': {
    name: 'CTE (Towards AYE) - Ang Mo Kio Ave 1',
    road: 'CTE',
    area: 'Ang Mo Kio',
  ...
  '1702': {
    name: 'CTE (Towards SLE) - Ang Mo Kio Ave 5',
    road: 'CTE',
    area: 'Ang Mo Kio',
  ...
  '1703': {
    name: 'CTE (Towards City) - Braddell Road',
    road: 'CTE',
    area: 'Bishan',
    direction: 'Towards City',
    isCheckpoint: false,
  ...
  '1704': {
    name: 'CTE (Towards SLE) - Moulmein Road',
    road: 'CTE',
    area: 'Novena',
    direction: 'Towards SLE',
    isCheckpoint: false,
  ...
  '3701': {
    name: 'AYE (Towards MCE) - Alexandra Road',
    road: 'AYE',
    area: 'Bukit Merah',
  ...
  '3702': {
    name: 'AYE (Towards Tuas) - Keppel Road',
    road: 'AYE',
    area: 'Tanjong Pagar',
    direction: 'Towards Tuas',
    isCheckpoint: false,
  ...
  '3704': {
    name: 'AYE (Towards Tuas) - Clementi Road',
    road: 'AYE',
    area: 'Clementi',
    direction: 'Towards Tuas',
    isCheckpoint: false,
  ...
  '3795': {
    name: 'AYE (Towards Tuas) - Tuas Road',
    road: 'AYE',
    area: 'Tuas',
